...
{
    [Item("BpEaRealVectorEncoding", "Describes a BP EA real vector encoding.")]
    [StorableClass]
    public sealed class BpEaRealVectorEncoding : Encoding<IRealVectorCreator>
    {
        ...
        [StorableConstructor]
        private BpEaRealVectorEncoding(bool deserializing) : base(deserializing) { }
        ...
        public override IDeepCloneable Clone(Cloner cloner) { return new BpEaRealVectorEncoding(this, cloner); }
        private BpEaRealVectorEncoding(BpEaRealVectorEncoding original, Cloner cloner)
